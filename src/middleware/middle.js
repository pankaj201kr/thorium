...
// module.exports.timeMid=timeMid


// <!-- ASSIGNMENT:- -->
// Write a middleware that logs (console.log) some data everytime any API is hit
// Data to be logged:-the current timestamp(as date time) ,
//  the IP of the user and the route being requested).
// For this first figure out how to get the route location 
// being requested, how to get current timestamp and how to get the IP.
